...
namespace Gaming_club
{
    ...
    public partial class Gaming_clubEntities : DbContext
    {
        public Gaming_clubEntities()
            : base("name=Gaming_clubEntities")
        {
        }
        ...
        public virtual DbSet<date_of_game_library> date_of_game_library { get; set; }
        public virtual DbSet<exclusive_game> exclusive_game { get; set; }
